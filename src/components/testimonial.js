  ...
  render() {
    ...
    return (
      <section
        ...
        className={`testimonial-section bg-color-grey section-have-half-bg ${this.state.color}`}
      >
            ...
            <div className="col-lg-12">
              <div className="testimonial-one-wrap">
                <div className="section-heading mb-50">
                  <span className="mb-3 ot">Our Testimonials</span>
                  <h2 className="title">
                    What Our <span className="last">Patients</span> Say About
                    Our Medical
                  </h2>
                </div>
                <Slider
